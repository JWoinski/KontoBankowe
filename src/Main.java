...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        KontoBankowe k4 = new KontoBankowe("Walutowe", "mBank", 4325234, "18092226728", 3, 1100, false, "");
        k4.wyplata(1200);
        ...
        final String summaryWyplataMax = kontoBankoweList.stream()
                .max((n1, n2) -> Integer.compare(
                        n1.getHistories()
                                ...
                                n2.getHistories()
                                .stream()
                                .filter(operation -> operation.getOperationType() == OperationType.WYPLATA)
                                        .map(History::getSum)
                                        .reduce(0, Integer::sum)))
                .map(KontoBankowe::getNazwa).orElse(null);
